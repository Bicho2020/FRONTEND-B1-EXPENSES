    ...
    if (cod_usuario) {
        ...
        if (cod_sociedad) {
            ...
            if (nombre_perfil == 'USUARIO') {
                ...
                PintarLogo();
                PintarDatosSociedad();
                ListarModulosSociedadesU(cod_usuario);
                EsJefeUser(cod_usuario);
            } else {
    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            if (x == "0") {
                ...
                $("#" + $.escapeSelector('/usuario/AprobacionJefe') + "").css({
                    "display": "none",

                });

                $("#" + $.escapeSelector('/usuario/AprobacionJefeRendicion') + "").css({
                    "display": "none",
...
const ListarModulosSociedadesU = (COD_USUARIO) => {
    ...
    const url = `http://192.168.0.22:81/api/modulo/usuarios/${COD_USUARIO}/${cod_sociedad}`;
    $.ajax({
        url: url,
        type: "GET",
        dataType: 'json',
...
const Pintar = () => {
    ...
    if (getURL == '/usuario/SolicitudFondo') {
   
        $("#D_SolicitudFondo").css({
    ...
    if (getURL == '/usuario/MisFondos') {
   
        $("#D_FondosSolicitados").css({
            "border-right": "4px solid #0abbec",
            "background-color": "rgb(235, 243, 250)"
        });
    }

    if (getURL == '/usuario/SolicitudRendicion') {

        $("#D_SolicitudRendicion").css({
            "border-right": "4px solid #0abbec",
            "background-color": "rgb(235, 243, 250)"
        });
    ...
    if (getURL == '/usuario/MisRendiciones') {

        $("#D_RendicionesSolicitadas").css({
            "border-right": "4px solid #0abbec",
            "background-color": "rgb(235, 243, 250)"
        });
    ...
    if (getURL == '/usuario/AprobacionJefe') {
    ...
    if (getURL == '/usuario/AprobacionJefeRendicion') {
